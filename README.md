...
Student: Irina Chihăiței (căs. Moroșanu) - Informatică ID, anul 2, grupa 1
...
- `highRiskCountries = {"KP", "IR", "MM"}` &mdash; coduri ISO 3166-1 alpha-2 pentru Coreea de Nord, Iran și Myanmar,
...
- `amount = 500.0`, `hourOfDay = 12`, `newBeneficiary = false`, `countryCode = "RO"`, `merchantCategory = "grocery"`,
  `transactionsLast24h = 5`, `averagePreviousAmount = 0.0`
...
|------|--------------------------------|----------|--------|----------|-----------|-----------------------------------|--------|-----------|--------|-----------------------------|
| TV1  | V1, V6, V9, V11, V13, V14, V16 | 70       | 11     | false    | "RO"      | "GROCERY STORES"                  | 5      | 0         | O1     | `APPROVED` (scor `0`)       |
| TV2  | V2, V5, V9, V11, V13, V15, V17 | 2500     | 3      | false    | "RO"      | "DENTAL AND MEDICAL LABORATORIES" | 15     | 1000      | O2     | `REQUIRES_2FA` (scor `45`)  |
| TV3  | V3, V7, V8, V10, V13, V14, V17 | 4000     | 23     | true     | "KP"      | "SHOE STORES"                     | 5      | 2000      | O3     | `MANUAL_REVIEW` (scor `80`) |
| TV4  | V4, V6, V8, V10, V13, V15, V18 | 6000     | 12     | true     | "IR"      | "GROCERY STORES"                  | 15     | 1000      | O4     | `BLOCKED` prin scor (`130`) |
| TV5  | V1, V6, V9, V11, V12, V14, V17 | 500      | 12     | false    | "RO"      | "GAMBLING"                        | 5      | 200       | O5     | `BLOCKED` prin blacklist    |
